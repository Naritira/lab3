...
public class Const extends Number implements Function {
    ...
    @Override
    public double calculate(double x) {return value;}
    @Override
    public Function derivative() {return ZERO;}
    @Override
    public String toPrettyString(NumberFormat nf) {return nf.format(value);}
    @Override
    ...
    public static Const of(double value) {return new Const(value);}}